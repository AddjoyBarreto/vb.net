...
Namespace DataSet2TableAdapters
    ...
    Partial Public Class BILLINGTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet2.BILLINGDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet2.BILLINGDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.BILLINGDataTable = New DataSet2.BILLINGDataTable()
